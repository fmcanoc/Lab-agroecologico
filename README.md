...
| **Vol. Sedimentación** | Volumen de Sedimentación (VS) |
...
| **Agregados** | Estabilidad de agregados — Índice Slakes (escala 0–1) |
...
### LABORATORIO EXTERNO
- **Análisis Externo** — Carga manual de resultados provenientes de laboratorios externos.

### MÉTRICAS
- **Resultados** — Visualización consolidada de todos los datos cargados.

### INFORMACIÓN
- **About** — Descripción del Kit, links al manual y al repositorio, autores y contacto.
