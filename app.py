    ...
    try:
        if request.method == 'POST':
            ...
            if tipo_formulario == 'registro_muestra':
                ...
                conexion.commit()
                return redirect(url_for('inicio') + '#muestras') # PUNTO 4
                ...
                return redirect(url_for('inicio') + '#carbono') # PUNTO 4
                ...
                return redirect(url_for('inicio') + '#ph') # PUNTO 4
                ...
                return redirect(url_for('inicio') + '#mop') # PUNTO 4
                ...
                return redirect(url_for('inicio') + '#estab') # PUNTO 4
...
def descargar_csv():
    ...
    # PUNTO 6: Corregido para que guarde los valores reales de la fila
...
def sincronizar_api():
    ...
    try:
        ...
        for fila in lector:
            ...
            # PUNTO 3: UPSERT conservando la información que envíe SurveyStack
            cur.execute('''
